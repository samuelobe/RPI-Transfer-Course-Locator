...
### Getting Started
The main.py script requires Python and Selenium. You can install Selenium by running, "pip install selenium". There is no need to download a driver. This repository comes with one.
